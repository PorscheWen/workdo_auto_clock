...
- **08:00-09:00**: 執行上班打卡
- **16:00-18:00**: 執行下班打卡
- **超過 17:45 時自動放棄下班打卡**（防護機制：避免實際打卡時間過晚）
- 自動檢查並補缺卡
- 自動跳過週末和假日
...
- **上班打卡**: 每週一至週五 **08:00**（台灣時間），每日 **1** 次（不因重試而連續觸發）
- **下班打卡**: 每週一至週五 **15:00**（台灣時間）觸發，預留 2+ 小時給 GitHub Actions 排程延遲，實際打卡時間約 **17:00** 前後
- **下班打卡截止防護**: 若實際執行時 **台灣時間已超過 17:45**，會放棄本次下班打卡並標記 workflow 失敗
