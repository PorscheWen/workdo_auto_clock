...
- **08:00-09:00**: 執行上班打卡
- **17:00-18:30**: 執行下班打卡
- **超過 18:30 時自動放棄下班打卡**（防護機制：避免實際打卡時間過晚）
- 自動檢查並補缺卡
- 自動跳過週末和假日
...
- **下班打卡**: 每週一至週五 **17:00**（台灣時間）觸發，**18:00 備援**（因 Actions 延遲），允許打卡時間 **17:00-18:30**
- **下班打卡截止防護**: 若實際執行時 **台灣時間已超過 18:30**，會放棄本次下班打卡並標記 workflow 失敗
